...
=======
    <title>Class Color API exported by pygame.color &#8212; pygame-ce v2.5.2 documentation</title>
    <link rel="stylesheet" type="text/css" href="../_static/pygments.css?v=fa44fd50" />
    <link rel="stylesheet" type="text/css" href="../_static/pygame.css?v=a9f2cf0f" />
    <script data-url_root="../" id="documentation_options" src="../_static/documentation_options.js?v=8dbccdf4"></script>
...
<span class="kt"><span class="pre">int</span></span><span class="w"> </span><span class="sig-name descname"><span class="n"><span class="pre">pg_RGBAFromObjEx</span></span></span><span class="sig-paren">(</span><span class="n"><span class="pre">PyObject</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">color</span></span>, <span class="n"><span class="pre">Uint8</span></span><span class="w"> </span><span class="n"><span class="pre">rgba</span></span><span class="p"><span class="pre">[</span></span><span class="p"><span class="pre">]</span></span>, <span class="n"><span class="pre">pgColorHandleFlags</span></span><span class="w"> </span><span class="n"><span class="pre">handle_flags</span></span><span class="sig-paren">)</span><a class="headerlink" href="#c.pg_RGBAFromObjEx" title="Permalink to this definition">¶</a><br /></dt>
...
<span class="kt"><span class="pre">int</span></span><span class="w"> </span><span class="sig-name descname"><span class="n"><span class="pre">pg_MappedColorFromObj</span></span></span><span class="sig-paren">(</span><span class="n"><span class="pre">PyObject</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">val</span></span>, <span class="n"><span class="pre">SDL_Surface</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">surf</span></span>, <span class="n"><span class="pre">Uint32</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">color</span></span>, <span class="n"><span class="pre">pgColorHandleFlags</span></span><span class="w"> </span><span class="n"><span class="pre">handle_flags</span></span><span class="sig-paren">)</span><a class="headerlink" href="#c.pg_MappedColorFromObj" title="Permalink to this definition">¶</a><br /></dt>
...
=======
        <li class="nav-item nav-item-0"><a href="../index.html">pygame-ce v2.5.2 documentation</a> &#187;</li>
          <li class="nav-item nav-item-1"><a href="../c_api.html" accesskey="U">pygame C API</a> &#187;</li>
        <li class="nav-item nav-item-this"><a href="">Class Color API exported by pygame.color</a></li> 
      </ul>
    </div>
