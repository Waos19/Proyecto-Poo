...
class WeaponPickupsManager:
    def __init__(self, weapon_types, spawn_interval=5000, max_pickups=5):
        ...
        self.pickups = []  # Lista para almacenar los pickups
    ...
    def generate_pickup(self):
        ...
        if len(self.pickups) < self.max_pickups:  # Limitar la cantidad de pickups en el mapa
            ...
            self.pickups.append(pickup)  # Uso de append para agregar el pickup a la lista
    ...
    def update(self, delta_time):
        ...
        # Actualizar cada pickup en la lista
        for pickup in self.pickups:
            pickup.update(delta_time)  # Llamamos a update() para cada pickup
